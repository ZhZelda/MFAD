...
def main(args):
    ...
    if args.asv_path:
        data_path = args.asv_path
        use_asv = True
    else:
        data_path = args.in_the_wild_path
        use_asv = False

    evaluate_nn(
        model_paths=config["checkpoint"].get("path", []),
        datasets_paths=[data_path],
...
def parse_args():
    ...
    IN_THE_WILD_DATASET_PATH = r"D:\\Desktop\\周子皓\\deepfake-whisper-features-main\\datasets\\release_in_the_wild"
    ...
    default_model_config = "D:\Desktop\周子皓\deepfake-whisper-features-main\configs\model__whisper_multifront_conformer__1748358820.2918918.yaml"
    parser.add_argument(
        "--config",
